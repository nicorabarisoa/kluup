...
<task type="tdd" tdd="true">
  ...
  <read_first>
    ...
    - .planning/phases/06-social-profile-archetypes-duo-awards/06-RESEARCH.md (§ Duo Awards Computation Details → 5 Pair Metrics table; PRIVACY NOTE on confession_overlap; Pattern 2)
  ...
  <action>
    ...
    before premium launch. No fenced code in the action — copy identifiers from 06-RESEARCH.md Pattern 2.
  </action>
  <verify>
...
<task type="tdd" tdd="true">
  ...
  <read_first>
    ...
    - .planning/phases/06-social-profile-archetypes-duo-awards/06-RESEARCH.md (§ Duo Awards Computation Details → Award Assignment Algorithm; Pattern 2; Pitfall 3 / P-19)
    - .planning/phases/06-social-profile-archetypes-duo-awards/06-PATTERNS.md (lib/awards.ts → Deterministic pair sort, Variety-rule award loop, No random comparator)
...
<output>
Create `.planning/phases/06-social-profile-archetypes-duo-awards/06-03-SUMMARY.md` when done
</output>
